...
The `nntc_encode` tool (for Windows or Linux, requires CUDA) compresses a 24-bpp texture, or a PBR material of up to six correlated 24-bpp textures, into **two mipmapped latent planes and a few dozen
