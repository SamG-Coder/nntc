...
The `nntc_encode` tool (for Windows or Linux) compresses a 24-bpp texture, or (typically PBR) material of up to six correlated 24-bpp textures, into **two mipmapped latent planes and a few dozen
