...
The `nntc_encode` tool (for Windows or Linux) compresses a PBR material set of up to six 24-bpp textures into **two mipmapped latent planes and (typically) a few dozen
